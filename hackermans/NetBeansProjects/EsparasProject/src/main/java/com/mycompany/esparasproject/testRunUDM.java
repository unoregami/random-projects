 ...
 * @author Charles
 */
public class testRunUDM extends javax.swing.JFrame {
    ...
    private void buttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonMouseClicked
        if (Integer.parseInt(number.getText()) >= 1000000000) {
            txtResult.setText("Input below 1000000000");
            number.setText(null);
        } else {
            int reverse_num = reverse(Integer.parseInt(number.getText()));
            txtResult.setText("" + reverse_num);        
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testRunUDM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new testRunUDM().setVisible(true);
            }
        });
    }
